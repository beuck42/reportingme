...
<html lang="en">
	...
	<body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-sidebar-closed">
		...
		<div class="page-container">
			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<div class="page-head">
						...
						<div class="page-title">
							<h1>Securinfor Dashboard
								<small>tableau des interventions 'à préparer'</small>
							</h1>
						</div>
						<!-- END PAGE TITLE -->
					...
					<div class="row">
						<table id="logistique" class="display" cellspacing="0" width="100%">
						</table>
					</div>
					<div class="row">
					</div>
		...
		<script src="/securinfor/public/js/logistique/init.js" type="text/javascript"></script>
		<script src="/securinfor/public/js/daterangepicker.js" type="text/javascript"></script>
		<script src="https://cdn.datatables.net/1.10.12/js/jquery.dataTables.min.js" type="text/javascript"></script>
		<script src="/securinfor/public/js/logistique/dataTable.js" type="text/javascript"></script>
