		...
		<div class="content">
			...
			<!-- <form class="login-form" action="connexion/connect" method="post"> -->
				...
				<div class="form-group">
					...
					<input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Pseudo/Mail" name="email" /> </div>
				<div class="form-group">
				...
				<div class="form-actions">
					<button type="submit" class="btn green uppercase">Connecte</button>
					<label class="rememberme check mt-checkbox mt-checkbox-outline">
						<input type="checkbox" name="remember" value="1" />Se Souvenir
						<span></span>
					</label>
					<a href="javascript:;" id="forget-password" class="forget-password">Mdp Oublié?</a>
				</div>
 <!--
				<div class="login-options">
					<h4>Only registered member could login</h4>
			...
			<form class="forget-form" action="index.html" method="post">
				...
				<p> Entrez votre adresse mail ci-dessous pour changer de mot de passe. </p>
				<div class="form-group">
					<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Mail" name="email" /> </div>
				<div class="form-actions">
